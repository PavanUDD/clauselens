...
EMPLOYMENT_RULES: list[Rule] = [
    ...
    Rule(
        ...
        detection_patterns=[
            ...
            r"engage\s+in\s+any\s+(business|competing)",
            r"work\s+for\s+any\s+competitor",
            r"directly\s+or\s+indirectly.{0,40}compet",
            r"months\s+following\s+the\s+termination",
            r"after\s+termination.{0,60}(compete|business|employ)",
        ],
    ...
    Rule(
        ...
        detection_patterns=[
            ...
            r"will\s+not\s+be\s+entitled\s+to\s+(any\s+)?severance",
            r"severance\s+shall\s+not",
            r"no\s+(severance\s+pay|continuation\s+of\s+benefits)",
            r"beyond\s+your\s+final\s+paycheck",
            r"final\s+paycheck\s+for\s+hours\s+worked",
        ],
    ...
    Rule(
        ...
        detection_patterns=[
            ...
            r"personal\s+time.{0,60}property\s+of\s+the\s+company",
            r"own\s+personal\s+equipment",
            r"whether\s+during\s+work\s+hours\s+or",
            r"sole\s+and\s+exclusive\s+property\s+of\s+the\s+company",
            r"develop\w*.{0,60}(belong|property|assign).{0,40}company",
        ],
    ...
    Rule(
        ...
        detection_patterns=[
            ...
            r"not\s+eligible\s+for\s+overtime",
            r"ineligible\s+for\s+overtime",
            r"overtime\s+(pay\s+)?will\s+not\s+be\s+paid",
            r"exempt\s+employee",
            r"salaried\s+exempt",
            r"regardless\s+of\s+hours\s+worked",
        ],
